...
const Hero = () => {
  ...
  // Fix Hydration Error: Generate particles only on the client
  useEffect(() => {
  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 z-0">
        ...
        {/* Particle Effect - Only renders when state is populated on client */}
              ...
              >
                ...
                <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
                  ...
                  <button
                    ...
                    className="px-6 py-3 border-2 border-white/30 hover:border-white rounded-full font-medium text-white text-base backdrop-blur-sm transition-all hover:scale-105 active:scale-95"
                  >
      ...
      {/* Floating Elements */}
      <div className="absolute top-1/4 left-4 sm:left-8 w-32 h-32 border border-white/10 rounded-full backdrop-blur-sm" />
      <div className="absolute bottom-1/4 right-4 sm:right-8 w-24 h-24 border border-white/10 rounded-full backdrop-blur-sm" />
    </section>
  );
};
